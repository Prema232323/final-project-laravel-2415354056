...
class CustomerController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view("customers.index", ["active" => "customers", "customers" => $customers]);
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return back()
            ...
            ->with(
                "toast_error", 
                $response->json("message")?? "Failed to create customer."
                );
    }
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        return back()
            ...
            ->with(
                "toast_error", 
                $response->json("message")?? "Failed to update customer."
                );
    }
    ...
    public function destroy($id): RedirectResponse
    {
        ...
        return back()
            ->with(
                "toast_error", 
                $response->json("message")?? "Failed to delete customer."
                );
    }
    ...
    public function activate($id): RedirectResponse
    {
        ...
        return back()
            ->with(
                "toast_error", 
                $response->json("message")?? "Failed to activate customer."
                );
    }
    ...
    public function deactivate($id): RedirectResponse
    {
        ...
        return back()
            ->with(
                "toast_error", 
                $response->json("message")?? "Failed to deactivate customer."
                );
    }
}