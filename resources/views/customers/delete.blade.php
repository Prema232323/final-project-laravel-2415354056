...
<div id="deleteDataModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40 backdrop-blur-sm p-4">
    <div class="w-full max-w-sm rounded-2xl bg-white shadow-xl">
        <div class="px-6 py-6 text-center">
            ...
            <h2 class="text-base font-bold text-gray-900">Delete Customer</h2>
            <p class="mt-1.5 text-sm text-gray-500">
                Are you sure you want to delete
                <span id="delete_customer_name" class="font-semibold text-gray-700"></span>?
        ...
        <form id="deleteForm" action="" method="POST" class="flex gap-3 border-t border-gray-100 px-6 py-4">
            ...
            <button type="button" onclick="closeDeleteModal()"
                class="flex-1 rounded-lg border border-gray-200 px-4 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors">
                Cancel
            </button>
            <button type="submit"
                class="flex-1 rounded-lg bg-red-600 px-4 py-2 text-sm font-semibold text-white hover:bg-red-700 active:scale-95 transition-all">
                Yes, Delete
            </button>
        </form>
    </div>
